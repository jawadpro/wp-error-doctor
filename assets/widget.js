(() => {
  ...
  function render(data){
    ...
    const evidence=result.querySelector('.wpd-evidence'); evidence.insertAdjacentHTML('afterend',`<a class="wpd-full-link" href="${escape(data.report_url)}" target="_blank">View full website report ↗</a>`); result.querySelector('.wpd-send').onclick=()=>show('lead'); result.querySelector('.wpd-again').onclick=()=>show('start'); show('result');
  }
